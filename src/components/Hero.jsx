  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodlogy to identify the credit cards most likely to fit your needs. We examines annual percentage rates, anuuak fees</p>
      </div>
